...
// import blog5 from "../assets/p1.jpg";
// import blog6 from "../assets/p1.jpg";
...
//       excerpt: "Quick and nutritious meal prep ideas for busy people.",
//       image: blog5,
//       category: "Nutrition",
//       date: "Aug 20, 2023",
//       readTime: "4 min"
...
//       excerpt: "Why taking rest days is crucial for muscle recovery.",
//       image: blog6,
//       category: "Wellness",
//       date: "Aug 15, 2023",
//       readTime: "5 min"
...
const BlogPage = () => {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      title: "Healthy Meal Prep Ideas",
      excerpt: "Quick and nutritious meal prep ideas for busy people.",
      fullContent: "Meal prepping can save time and ensure you stay on track with your nutrition goals. Discover easy, delicious recipes and practical tips for preparing a week's worth of healthy meals in just a few hours.",
      image: blog5,
      category: "Nutrition",
      date: "Aug 20, 2023",
      readTime: "4 min",
    ...
    },
    {
      ...
      title: "The Importance of Rest Days",
      excerpt: "Why taking rest days is crucial for muscle recovery.",
      fullContent: "Rest is when your body repairs and grows stronger. Learn about the science behind recovery, signs you need a rest day, and active recovery techniques that can enhance your performance.",
      image: blog6,
      category: "Wellness",
      date: "Aug 15, 2023",
      readTime: "5 min",
      author: "Lisa Therapist",
      authorImage: author
    }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div>
          ...
          <div className="grid grid-cols-6 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {filteredPosts.map(post => (
              <article 
                key={post.id} 
